...
export const FlipCameraIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M20 10c0-4.4-3.6-8-8-8s-8 3.6-8 8 0 4.4 3.6 8 8 8"/><path d="M4 14l-4-4 4-4"/></svg>
);
...
export const FlashOffIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" strokeOpacity="0.3" />
    <line x1="2" y1="2" x2="22" y2="22" />
  </svg>
);

export const FlashOnIcon = ({ className }: { className?: string }) => (
...
export const FlashAutoIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
    <path d="M18 22v-4" />
    <path d="M18 18h2" />
    <text x="16" y="24" fontSize="10" fontWeight="bold" stroke="none" fill="currentColor">A</text>
  </svg>
);
